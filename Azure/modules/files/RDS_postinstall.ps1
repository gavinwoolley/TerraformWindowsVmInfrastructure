...
function Install-Software {
    ...
    `$packages = @(
        ...
        @{title = 'Adobe Reader 19.021.20061'; url = 'http://ardownload.adobe.com/pub/adobe/reader/win/AcrobatDC/1902120058/AcroRdrDC1902120058_en_US.exe'; Arguments = ' /sAll /rs'; Destination = `$source }
    )
